// AUTO-GENERATED — canonical Wordle word list (2315 words).
// The set of possible hidden solutions (the answer space).
// Every entry is validated to match /^[a-z]{5}$/. Regenerate via scripts, do not hand-edit.
